...
def copy_block(block_official, block_ours):
    ...
    # Attention
    # copy_parameter(b_a.attn.c_attn.weight.T, b_b.attention.c_attn.weight.T)
    # print(b_a.attn.c_attn.weight.T.shape)
    # copy_parameter(b_a.attn.c_attn.bias, b_b.attention.c_attn.bias)
    # print(b_a.attn.c_attn.bias.shape)
